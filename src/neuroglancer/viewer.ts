 ...
 */
 ...
 import svg_book from 'ikonate/icons/book-opened.svg'
 ...
 // ***test***
 import {ReadmeDialog} from 'neuroglancer/ui/readme_panel';
 // ***
 ...
 export class Viewer extends RefCounted implements ViewerState {
   ...
   private makeUI() {
     ...
     // ***test***
     {
       const button = makeIcon({svg: svg_book, title: 'How to use'});
       this.registerEventListener(button, 'click', () => {
         this.redmePanaleState();
       });
       this.registerDisposer(new ElementVisibilityFromTrackableBoolean(
           this.uiControlVisibility.showReadmeButton, button));
       topRow.appendChild(button);
     }
